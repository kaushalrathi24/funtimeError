...
const getTimeline_dto_1 = require("./dto/getTimeline.dto");
let LinkedinController = exports.LinkedinController = class LinkedinController {
    ...
    async getTimeline(getTimelineDto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [getTimeline_dto_1.GetTimelineDto]),
    __metadata("design:returntype", Promise)
], LinkedinController.prototype, "getTimeline", null);
